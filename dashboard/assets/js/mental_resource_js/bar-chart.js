...
svg_bar.append("text")
    ...
    .text("Resource Density per 1000 People"); // The text label for the X-axis
    ...
    function updateBarChart() {
        ...
        updatedData = updatedData.map(function (d) {
            ...
            if (d.stateId) {
                ...
                resourcesPerThousand = (d.resource / population) * 1000;
            } else if (d.county) {
        ...
        .on("mouseover", function (event, d) {
            ...
            let population;
                ...
                tooltipContent += `Resources per 1,000 People: <strong>${resourcesPerThousand.toFixed(2)}</strong>`;
