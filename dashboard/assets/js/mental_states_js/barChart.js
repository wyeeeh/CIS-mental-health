...
function drawHeatMap(hoverdCountry) {
    ...
    d3.json('../data/mental_states/races_2023.json').then(data => {
        ...
        const legendTicks = d3.range(d3.max(state_data, d => d.value)/10, 1.05*d3.max(state_data, d => d.value),d3.max(state_data, d => d.value)/10); // Adjust the number of ticks as needed
        ...
        heat_svg.selectAll("color-text")
            ...
            .attr("y", function(d,i){return legend_y+15*i+16;}) // Adjust the Y position for text
            .attr("dy", "0.2em")
            .attr('font-size','10px')
        ...
        heat_svg.selectAll("color-line")
            ...
            .attr("y1", function(d,i){return legend_y+15*i+15;}) // Adjust the Y position for text
            .attr("x2",legend_x+25)
            .attr('y2',function(d,i){return legend_y+15*i+15;})
